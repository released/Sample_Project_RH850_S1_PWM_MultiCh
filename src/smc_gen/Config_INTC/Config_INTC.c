...
void R_Config_INTC_Create(void)
{
    ...
    INTC2.ICP6.UINT16 &= _INT_PRIORITY_LOWEST;
    FCLA0.CTL6_INTPL = _INTC_EDGE_BOTH;
    /* Synchronization processing */
    g_cg_sync_read = FCLA0.CTL6_INTPL;
    __syncp();
    /* Set INTP6 pin */
...
* Description  : This function enables INTP6 interrupt.
* Arguments    : None
* Return Value : None
***********************************************************************************************************************/
...
* Description  : This function disables INTP6 interrupt.
* Arguments    : None
* Return Value : None
***********************************************************************************************************************/
